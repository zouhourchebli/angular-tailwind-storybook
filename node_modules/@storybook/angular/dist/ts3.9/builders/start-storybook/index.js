...
function commandBuilder(options, context) {
    return rxjs_1.from(setup(options, context)).pipe(operators_1.switchMap(function (_a) {
        ...
        return options.compodoc
            ...
            : rxjs_1.of({});
    }), operators_1.map(function () { return (__assign(__assign({}, options), { angularBrowserTarget: options.browserTarget })); }), operators_1.switchMap(function (standaloneOptions) { return runInstance(standaloneOptions); }), operators_1.map(function () {
        return { success: true };
    }));
}
