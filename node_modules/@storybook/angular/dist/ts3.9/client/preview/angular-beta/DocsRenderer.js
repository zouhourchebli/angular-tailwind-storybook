...
var DocsRenderer = /** @class */ (function (_super) {
    __extends(DocsRenderer, _super);
    function DocsRenderer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DocsRenderer.prototype.render = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        channel = addons_1.addons.getChannel();
                        /**
                         ...
                         *
                         */
                        channel.once(core_events_1.default.STORY_CHANGED, function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, DocsRenderer.resetPlatformBrowserDynamic()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                        ...
                        return [4 /*yield*/, _super.prototype.render.call(this, __assign(__assign({}, options), { forced: false }))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, AbstractRenderer_1.AbstractRenderer.resetCompiledComponents()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DocsRenderer.prototype.beforeFullRender = function () {
