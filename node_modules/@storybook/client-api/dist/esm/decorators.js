...
var bindWithContext = function bindWithContext(storyFn, getStoryContext) {
...
export var decorateStory = function decorateStory(storyFn, decorator, getStoryContext) {
  ...
  var boundStoryFunction = bindWithContext(storyFn, getStoryContext);
...
export var defaultDecorateStory = function defaultDecorateStory(storyFn, decorators) {
  ...
  var decoratedWithContextStore = decorators.reduce(function (story, decorator) {
    return decorateStory(story, decorator, function () {
      return contextStore;
    });
  }, storyFn);
  return function () {
