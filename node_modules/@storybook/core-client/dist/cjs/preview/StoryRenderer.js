...
var document = _global.default.document; // We have "changed" story if this changes
  ...
  _createClass(StoryRenderer, [{
    ...
    value: function () {
      var _renderStory = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref7) {
        var context, _ref7$context, id, getDecorated, applyLoaders, runSetupFunction, unboundStoryFn, forceRender, storyContext, storyFn;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 2;
                applyLoaders = context.applyLoaders, runSetupFunction = context.runSetupFunction, unboundStoryFn = context.unboundStoryFn, forceRender = context.forceRender;
                _context3.next = 6;
                return applyLoaders();
              ...
              case 10:
                if (!((0, _csf.isCsf3Enabled)() && !forceRender)) {
                  _context3.next = 13;
                  break;
                }

                _context3.next = 13;
                return runSetupFunction();
