...
function commandBuilder(options, context) {
    return rxjs_1.from(setup(options, context)).pipe(operators_1.switchMap(function (_a) {
        var browserOptions = _a.browserOptions;
        return options.compodoc
            ? run_compodoc_1.runCompodoc({ compodocArgs: options.compodocArgs, tsconfig: browserOptions.tsConfig }, context)
            : rxjs_1.of({});
    }), operators_1.map(function () { return (__assign(__assign({}, options), { angularBrowserTarget: options.browserTarget })); }), operators_1.switchMap(function (standaloneOptions) { return runInstance(__assign(__assign({}, standaloneOptions), { mode: 'static' })); }), operators_1.map(function () {
        return { success: true };
    }));
}
function setup(options, context) {
    return __awaiter(this, void 0, void 0, function () {
        var browserTarget, browserOptions, _a, _b, _c;
