...
var DocsRenderer_1 = require("./DocsRenderer");
var CanvasRenderer_1 = require("./CanvasRenderer");
var RendererFactory = /** @class */ (function () {
    function RendererFactory() {
        this.rendererMap = new Map();
    }
    RendererFactory.prototype.getRendererInstance = function (storyId, targetDOMNode) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.rendererMap.get(storyId)];
                }
            });
        });
    };
    RendererFactory.prototype.buildRenderer = function (storyId, renderType) {
        if (renderType === 'docs') {
...
exports.getRenderType = function (targetDOMNode) {
